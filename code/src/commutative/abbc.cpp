...
void abbc(celerity::distr_queue& queue,
  ...
  queue.submit([=](celerity::handler& cgh){
      auto D = buff_c.get_access<cl::sycl::access::mode::read>(cgh, celerity::access::slice<2>(0));
      auto C = buff_d.get_access<cl::sycl::access::mode::read>(cgh, celerity::access::slice<2>(1));
